      ...
      <CardContent className="pt-6">
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            {record.publication_date || 'Non spécifié'}
          </div>
        ...
        <tbody>
          {jobResults?.data.map((job) => (
            ...
            >
              ...
              <td className="p-6 text-muted-foreground">{job.publication_date || 'Non spécifié'}</td>
              <td className="p-6">
        ...
        <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-4 flex items-center justify-between">
          <div>
            ...
            <p className="text-green-600 dark:text-green-300">
              {jobResults.data.length} offre{jobResults.data.length !== 1 ? 's' : ''} trouvée{jobResults.data.length !== 1 ? 's' : ''}
            </p>
          </div>
        </div>
      </div>
